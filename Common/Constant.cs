...
namespace Common
{
    ...
    {
        public static string spAppLogin = "SpAppLogin";
        ...
        public static string spUpdateMenu = "SpUpdateMenu";
        ...
        public static string spUpdateSubCategory = "SpUpdateSubCategory";
        ...
        public static string spGetByIdBrand = "SpGetByIdBrand";
        public static string spGetAllBrand = "SpGetAllBrand";
        public static string spGetAllBrandForUser = "SpGetAllBrandForUser";
        public static string spAddBrand = "SpAddBrand";
        public static string spUpdateBrand = "SpUpdateBrand";
        public static string spDeleteBrand = "SpDeleteBrand";

        public static string spGetByIdColor = "SpGetByIdColor";
        public static string spGetAllColor = "SpGetAllColor";
        public static string spGetAllColorForUser = "SpGetAllColorForUser";
        public static string spAddColor = "SpAddColor";
        public static string spUpdateColor = "SpUpdateColor";
        public static string spDeleteColor = "SpDeleteColor";

        public static string spGetByIdSize = "SpGetByIdSize";
        public static string spGetAllSize = "SpGetAllSize";
        public static string spGetAllSizeForUser = "SpGetAllSizeForUser";
        public static string spAddSize = "SpAddSize";
        ...
        public static string spGetAllRefundOrder = "SpGetAllRefundOrder";
        public static string spUpdateRefundOrderStatus = "SpUpdateRefundOrderStatus";
